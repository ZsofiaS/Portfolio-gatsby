      ...
      <div className="row">
        ...
        <h2 className="display-4 main__title">My tools & interests</h2>
          ...
          <p className="bullet">
            ...
            <p className="bullet">
              <FaTag className="icons" />Testing: RSpec, Capybara, Jasmine, Cypress, Jest, Enzyme</p>
            <p className="bullet">
              <FaBook className="icons" />Backend: Node.js, Express, Sinatra, Firebase</p>
            <p className="bullet">
              <FaWrench className="icons" />Database: MongoDB, PostgreSQL, Firebase/Firestore, SQLite</p>
            <p className="bullet">
              <FaSearch className="icons" />Agile: TDD, Extreme Programming, Continuous Integration, Git</p>
            <p className="bullet">
              <FaMap className="icons" />Exploring: React Native, Redux</p>
            <p className="bullet">
